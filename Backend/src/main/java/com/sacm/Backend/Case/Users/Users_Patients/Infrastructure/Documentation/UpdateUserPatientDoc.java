...
@Operation(
        ...
        description = """
        Este endpoint permite actualizar los datos de acceso (login) de un usuario administrativo.
        Campos actualizables: usuario, correo electrónico, contraseña.
        """
)
@ApiResponses({
        @ApiResponse(
                                ...
                                example = """
                {
                  ...
                  "errorCode": "200 OK",
                  "details": "Datos del usuario modificados exitosamente",
...
public @interface UpdateUserPatientDoc {
}
